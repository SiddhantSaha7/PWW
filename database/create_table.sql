...
CREATE TABLE PUBLIC_ACCESS_DATES_PWW(
    ...
    PublicAccessEndDate DATE NOT NULL DEFAULT('2999-12-31'),
...
CREATE TABLE PWW_ENTRY_AUTHOR_INTERSECTION(
    ...
    CONSTRAINT PWW_ENTRY_AUTHOR_INTERSECTION_FK2_1 FOREIGN KEY(PWWAuthorId) REFERENCES PWW_AUTHOR(PWWAuthorId) ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE CITED_WORKS(
    ...
    DOI MEDIUMTEXT NULL,
    CONSTRAINT CITED_WORKS_PK PRIMARY KEY(PWWCitedWorkCitationId),
    CONSTRAINT CITED_WORKS_AK_1_1 UNIQUE(GivenCitation)
);

ALTER TABLE CITED_WORKS AUTO_INCREMENT=5000;
...
CREATE TABLE PWW_TAGGED_CITED_WORKS(
    ...
    CONSTRAINT PWW_TAGGED_CITED_WORKS_FK_2_1 FOREIGN KEY(PWWCitedWorkCitationID) REFERENCES CITED_WORKS(PWWCitedWorkCitationID) ON UPDATE NO ACTION ON DELETE CASCADE    
);
...
CREATE TABLE USER_INFORMATION(
    ...
    UserAccessEndDate DATE NOT NULL DEFAULT('2999-12-31'),
...
ALTER TABLE USER_INFORMATION AUTO_INCREMENT=100000;
