CREATE VIEW PWW_DATABASE.PUBLIC_ACCESS_VIEW AS (
    SELECT 
    PWW_ENTRY.PWWEntryId, PWW_ENTRY.PWWTitle,  PWW_ENTRY.PWWShortDescription, PWW_ENTRY.PWWAdditionalNotes, PWW_ENTRY.CitationPageStart, PWW_ENTRY.CitationPageEnd, PWW_ENTRY.CitationMediaType, PWW_ENTRY.CitationDOI, PWW_ENTRY.CitationYear, PWW_ENTRY.PWWSourceUrl, PWW_ENTRY.PWWGraphicRightsHolder,  PWW_ENTRY.ProofPdf , 
    ...
    where
    PWW_ENTRY.PublishStatus= 'PublicAccessPublished'
